	TheGamePD u0 (
		...
		.mmo_new_signal                  (<connected-to-mmo_new_signal>),                  //    mmo.new_signal
		.mmo_new_signal_1                (<connected-to-mmo_new_signal_1>),                //       .new_signal_1
		.mmo_new_signal_2                (<connected-to-mmo_new_signal_2>),                //       .new_signal_2
		.mmo_new_signal_3                (<connected-to-mmo_new_signal_3>),                //       .new_signal_3
		.mmo_new_signal_4                (<connected-to-mmo_new_signal_4>),                //       .new_signal_4
		.mmo_new_signal_5                (<connected-to-mmo_new_signal_5>),                //       .new_signal_5
		.mmo_new_signal_6                (<connected-to-mmo_new_signal_6>)                 //       .new_signal_6
	);

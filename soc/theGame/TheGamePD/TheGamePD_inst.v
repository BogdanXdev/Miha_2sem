	TheGamePD u0 (
		...
		.clk_o_clk                       (<connected-to-clk_o_clk>),                       //   clk_o.clk
		.o_mmo_write                     (<connected-to-o_mmo_write>),                     //   o_mmo.write
		.o_mmo_read                      (<connected-to-o_mmo_read>),                      //        .read
		.o_mmo_address                   (<connected-to-o_mmo_address>),                   //        .address
		.o_mmo_writedata                 (<connected-to-o_mmo_writedata>),                 //        .writedata
		.o_mmo_byteenable                (<connected-to-o_mmo_byteenable>),                //        .byteenable
		.o_mmo_readdata                  (<connected-to-o_mmo_readdata>),                  //        .readdata
		.reset_o_reset                   (<connected-to-reset_o_reset>)                    // reset_o.reset
	);

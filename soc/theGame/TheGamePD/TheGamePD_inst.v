	TheGamePD u0 (
		...
		.mmo_o_reset                     (<connected-to-mmo_o_reset>),                     //    mmo.o_reset
		.mmo_o_mmo_address               (<connected-to-mmo_o_mmo_address>),               //       .o_mmo_address
		.mmo_o_mmo_writedata             (<connected-to-mmo_o_mmo_writedata>),             //       .o_mmo_writedata
		.mmo_o_mmo_byteenable            (<connected-to-mmo_o_mmo_byteenable>),            //       .o_mmo_byteenable
		.mmo_o_mmo_read                  (<connected-to-mmo_o_mmo_read>),                  //       .o_mmo_read
		.mmo_i_mmo_readdata              (<connected-to-mmo_i_mmo_readdata>),              //       .i_mmo_readdata
		.mmo_o_mmo_write                 (<connected-to-mmo_o_mmo_write>),                 //       .o_mmo_write

	TheGamePD u0 (
		...
		.sti_reset_o_sti_reset           (<connected-to-sti_reset_o_sti_reset>),           // sti_reset.o_sti_reset
		.sto_ready                       (<connected-to-sto_ready>),                       //       sto.ready
		.sto_valid                       (<connected-to-sto_valid>),                       //          .valid
		.sto_data                        (<connected-to-sto_data>),                        //          .data
		.sto_endofpacket                 (<connected-to-sto_endofpacket>),                 //          .endofpacket
		.sto_startofpacket               (<connected-to-sto_startofpacket>),               //          .startofpacket
		.sto_reset_o_sto_reset           (<connected-to-sto_reset_o_sto_reset>)            // sto_reset.o_sto_reset
	);
